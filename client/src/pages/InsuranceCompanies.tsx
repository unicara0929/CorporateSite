          ...
          <div className="container max-w-4xl">
            <ul className="space-y-4">
              {companies.map((company, index) => (
                <AnimatedSection key={company} delay={index * 0.04}>
                  <li className="flex items-center text-[#1A1A2E]/80 text-base md:text-lg font-body border-b border-gray-100 pb-4">
